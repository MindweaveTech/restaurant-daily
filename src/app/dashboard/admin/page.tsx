...
import { ChefHat, Users, Building2, TrendingUp, Clock, FileText, Settings, Plus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Welcome Message */}
        <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-lg p-6 text-white mb-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Pending Vouchers</p>
                <p className="text-2xl font-semibold text-gray-900">0</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 ml-3">Invite Staff</h3>
            </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 ml-3">Cash Sessions</h3>
            </div>
            <p className="text-gray-600 mb-4 text-sm">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 ml-3">Vouchers</h3>
            </div>
            <p className="text-gray-600 mb-4 text-sm">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 ml-3">Restaurant Settings</h3>
            </div>
            <p className="text-gray-600 mb-4 text-sm">
