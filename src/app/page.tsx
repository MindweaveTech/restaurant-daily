...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-orange-50 to-red-50 py-12 md:py-20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 text-sm md:text-base text-gray-500 mb-8">
              <Shield className="h-5 w-5" />
              <span>Secure • Mobile-First • Built for Indian Restaurants</span>
            </div>
            <Link
              href="/auth/phone"
              className="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white font-semibold py-4 px-10 rounded-lg text-lg transition-colors duration-200 shadow-lg"
            >
              Get Started Free
      ...
      {/* Final CTA Section */}
      <section className="py-12 md:py-20 bg-gradient-to-br from-orange-600 to-red-600">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <Link
            href="/auth/phone"
            className="inline-flex items-center gap-2 bg-white hover:bg-gray-100 text-orange-600 font-semibold py-4 px-10 rounded-lg text-lg transition-colors duration-200 shadow-lg"
          >
            Get Started Free
            <ArrowRight className="h-5 w-5" />
          </Link>
